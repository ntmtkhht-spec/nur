...
import 'core/services/location_refresher.dart';
...
class _MainShell extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // Side-effect watch: keeps the position current as the phone travels,
    // so prayer times follow it without anyone tapping anything. See
    // locationRefresherProvider.
    ref.watch(locationRefresherProvider);
