...
class TasbihScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      // Scrollable with a floor of the viewport height: the column is laid
      // out as before wherever it fits, and on shorter phones the hint at the
      // bottom can be reached instead of being cut off.
      body: SafeArea(
        child: LayoutBuilder(
...
class _CircularCounter extends StatelessWidget {
  ...
  /// Outer diameter. The screen shrinks it on short phones so the counter,
  /// the hint and everything between still share one screen.
  final double size;
...
class _TasbihArcPainter extends CustomPainter {
  ...
  @override
  bool shouldRepaint(covariant _TasbihArcPainter old) =>
